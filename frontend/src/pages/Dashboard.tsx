...
import { Loader2, CheckCircle2, AlertCircle, BarChart3, Database, LineChart, FileText, BrainCircuit, Sparkles, Activity, ShieldCheck, FileDown, AlertTriangle, Target, Lightbulb, Rocket } from 'lucide-react';
                ...
                <CardHeader className="border-b border-slate-200 dark:border-gray-700 pb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">Confidential Executive Memo • Generated by FiveMinds Strategist</p>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="pt-8">
                  <ScrollArea className="h-[700px] pr-6">
                    <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-h1:text-3xl prose-h1:text-blue-700 dark:prose-h1:text-blue-400 prose-h2:text-xl prose-h2:text-slate-800 dark:prose-h2:text-slate-200 prose-p:text-slate-600 dark:prose-p:text-slate-300 prose-p:leading-relaxed prose-li:text-slate-600 dark:prose-li:text-slate-300 prose-strong:text-slate-900 dark:prose-strong:text-white">
                      <pre className="whitespace-pre-wrap font-sans text-base leading-relaxed bg-transparent p-0 m-0 text-inherit">{strategist?.report || JSON.stringify(strategist, null, 2)}</pre>
                    </div>
                  </ScrollArea>
                </CardContent>
              </Card>
